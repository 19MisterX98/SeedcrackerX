...
|-------------------|------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 26.2              | [2.16.1](https://github.com/19MisterX98/SeedcrackerX/releases/download/2.16.1/seedcrackerX-2.16.1.jar) | [Fabric mod loader 0.14.0+](https://fabricmc.net/use/)                                                                                                                                         |
