...
|------------------|------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1.19.4           | [2.14.1](https://github.com/19MisterX98/SeedcrackerX/releases/download/prerelease/seedcrackerX-2.14.1.jar) | [Fabric mod loader 0.14.0+](https://fabricmc.net/use/)                                                                                                                                         |
...
Искаженных грибы больше не работают, поэтому не существует способа найти сид нижнего мира, однако вы можете попровать найти сид самостоятельно используя данный код [Nether_Bedrock_Cracker](https://github.com/19MisterX98/Nether_Bedrock_Cracker) - [Гайд на русском языке о том как его использовать](https://youtu.be/rXIF1hIxj0A)
