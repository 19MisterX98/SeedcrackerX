...
## Команды
  ...
  Когда вы покинете мир, мод сохранит собранную в данный момент информацию о структурах в папке .minecraft/config.
...
[saom88n](https://github.com/saom88n) - перевод README на русский
