...
public class Database {
    ...
    public static void handleDatabaseCall(Long seed) {
        ...
        String serverIp = client.getConnection() != null && client.getConnection().getConnection() != null ?
                client.getConnection().getConnection().getRemoteAddress().toString() : "localhost";
        String dimension = client.level != null ? client.level.dimension().location().getPath() : "overworld";
