...
public class Log {
    ...
    public static void warn(String translateKey, Object... args) {
        String message = String.format(translate(translateKey), args);
        Player player = getPlayer();
    ...
    public static void printSeed(String translateKey, long seedValue) {
        ...
        Component text = ComponentUtils.wrapInSquareBrackets(
            Component.literal(seed).withStyle(style -> style.withColor(ChatFormatting.GREEN)
    ...
    public static void printDungeonInfo(String message) {
        Component text = ComponentUtils.wrapInSquareBrackets(
            Component.literal(message).withStyle(style -> style.withColor(ChatFormatting.GREEN)
